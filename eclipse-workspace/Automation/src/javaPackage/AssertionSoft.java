...
public class AssertionSoft {
	...
	public void testCase1() throws Exception {
		...
		SoftAssert sa = new SoftAssert();
	     ...
	     sa.assertEquals(actualMessage,expectedresult,"Actaul and expected not matching" );
	     System.out.println("equal assertion verifiied");
	     
		
	     Thread.sleep(2000);
	     sa.assertFalse(driver.findElement(By.id("username-error")).isSelected());
	     System.out.println("False assertion verifiied");
	     sa.assertTrue(driver.findElement(By.id("username-error")).isDisplayed());
